...
-- 2. Update existing queries to valid status FIRST (before adding constraint)
UPDATE queries
...
-- 3. Now add new constraint with ALL 10 status values
ALTER TABLE queries
...
-- 4. Add stage tracking fields to queries table
ALTER TABLE queries
...
-- 5. Add booking fields to query_services table
...
-- 6. Add constraints for booking_status and delivery_status
ALTER TABLE query_services
